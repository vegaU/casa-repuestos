...
{
    public function store(Request $request, Tenant $tenant, Sale $sale, AuditService $audit)
    {
        ...
        $audit->record($request, $tenant->id, 'sale.payment_created', $payment, [], ['amount'=>$payment->amount,'method'=>$payment->method,'sale_id'=>$sale->id]);
